...
Cette opération s'effectue avec la commande +git merge+ suivi du nom de la branche que l'on souhaite fusionner.
...
- *Avantage* : la lisibilité de l'histoire de la branche principale redevienne plus directe.
